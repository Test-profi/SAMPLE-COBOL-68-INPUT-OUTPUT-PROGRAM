...
//ALLOC2   DD  DSN=WEEK4.DEV.COPYBOOK,                              
//             DISP=(NEW,CATLG,DELETE),                               
//             UNIT=TSO,                                              
//             SPACE=(CYL,(1,1,15),RLSE),                             
//             DCB=(LRECL=80,RECFM=FB,BLKSIZE=27920,DSORG=PO)         
...
//ALLOC4   DD  DSN=WEEK4.DEV.LOADLIB,                               
//             DISP=(NEW,CATLG,DELETE),                               
//             UNIT=TSO,                                              
...
//INFILE1  DD  DSN=WEEK4.DEV.INPUT.INVMAST,                                
//             DISP=(NEW,CATLG,DELETE),                               
//             UNIT=TSO,                                              
//             SPACE=(CYL,(1,1),RLSE),                                
...
//INFILE2  DD  DSN=WEEK4.DEV.INPUT.TRANFILE,                                
//             DISP=(NEW,CATLG,DELETE),                               
//             UNIT=TSO,                                              
//             SPACE=(CYL,(1,1),RLSE),                                
//             DCB=(LRECL=80,RECFM=FB,BLKSIZE=27920,DSORG=PS)         
...
//OUTFILE  DD  DSN=WEEK4.DEV.OUTPUT1,                               
//             DISP=(NEW,CATLG,DELETE),                               
//             UNIT=TSO,                                              
//             SPACE=(CYL,(2,2),RLSE),                                
//             DCB=(LRECL=80,RECFM=FB,BLKSIZE=27920,DSORG=PS)         
